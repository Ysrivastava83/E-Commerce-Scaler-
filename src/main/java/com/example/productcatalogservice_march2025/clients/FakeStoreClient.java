package com.example.productcatalogservice_march2025.clients;
...
public class FakeStoreClient
{
   ...
   // FakeStoreProductDto fakeStoreProductDto=requestForEntity(HttpMethod.PUT,"https://fakestoreapi.com/products/{id}",fakeStoreProductDto,FakeStoreProductDto.class,id).getBody();
